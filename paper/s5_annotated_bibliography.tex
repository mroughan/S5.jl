...
sequences.}
Voss is another early application paper connecting base sequences with fractal
correlation and spectral language. It belongs in the bibliography as a classic
DNA application reference, even though S5.jl should continue to describe its own
generators as finite simulations rather than as biological genome models.
